...
def build_deck():
    ...
    add_text_box(slide, Inches(0.8), Inches(1.0), Inches(8), Inches(0.7),
    ...
    add_text_box(slide, Inches(0.8), Inches(1.0), Inches(10), Inches(0.7),
                 ...
                 color=TEXT_WHITE, bold=True)
    add_text_box(slide, Inches(0.8), Inches(1.7), Inches(10), Inches(0.35),
    ...
    add_accent_bar(slide, Inches(0.8), Inches(2.0), Inches(11.5), ELASTIC_GOLD)
