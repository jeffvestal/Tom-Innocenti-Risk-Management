...
export function ApiKeyInput({
  ...
  return (
    <div className="rounded-xl border border-slate-200/80 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/50 p-6">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2.5 pr-10 rounded-lg text-sm
                     bg-slate-50 dark:bg-slate-900/70 border border-slate-300/60 dark:border-slate-600/50
      ...
      {/* Language toggle */}
      <div className="mt-4 pt-4 border-t border-slate-200/60 dark:border-slate-700/40 flex items-center justify-between">
        <div>
        ...
        <div className="inline-flex rounded-lg bg-slate-100 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-700/50 p-1">
