  ...
  return (
    <div className="rounded-xl border border-slate-700/50 bg-slate-800/50 p-6">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-slate-200">Jina API Key</h3>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2.5 pr-10 rounded-lg text-sm
                     bg-slate-900/70 border border-slate-600/50 text-slate-200
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 mt-3 text-xs text-amber-400
      ...
      <div className="mt-4 pt-4 border-t border-slate-700/40 flex items-center justify-between">
        <div>
          <span className="text-sm font-semibold text-slate-200">Language(s) to Import</span>
          <p className="text-[11px] text-slate-500 mt-0.5">The EU AI Act PDF will be fetched and parsed per language</p>
        </div>
        <div className="inline-flex rounded-lg bg-slate-900/60 border border-slate-700/50 p-1">
